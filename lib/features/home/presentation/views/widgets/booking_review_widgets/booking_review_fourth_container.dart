      ...
      child: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomImage(width: 22.w, height: 17.h, url: "assets/images/Group.png"),
                        Text("30% off  10 booking (up to EGP 150)",style: Styles.textStyle10.copyWith(
                          color: Colors.grey
                        ),),
                        CustomButton(
                          text: "Apply",
          ...
          Padding(
            ...
            child: Text("Booking Charges",style: Styles.textStyle14.copyWith(fontWeight: FontWeight.w500),)
          ),
          Divider(
            color: Colors.black.withOpacity(.15), // Set the color of the line
            thickness: 1,
            ...
            child: Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("x1 Day EGP 100.0 x 1 Seat",style: Styles.textStyle14.copyWith(fontWeight: FontWeight.w500),),
                    Text("EGP 100.0",style: Styles.textStyle14.copyWith(fontWeight: FontWeight.w500),)
                  ],
                ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Total Due",style: Styles.textStyle14.copyWith(fontWeight: FontWeight.w500,color: kMostColorPicked),),
                    Text("EGP 100.0",style: Styles.textStyle14.copyWith(fontWeight: FontWeight.w500,color: kMostColorPicked),)
                  ],
                )
              ],
            ),
