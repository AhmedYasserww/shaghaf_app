...
class _PhotoSessionsViewBodyState extends State<PhotoSessionsViewBody> {
  ...
  Widget build(BuildContext context) {
    ...
    const SafeArea(child:CustomAppBarTitleAndArrow(title: "Photo Session") ),
    SizedBox(height: 24.h),
      PhotoSessionListView(onItemSelected:updateItemSelected,),
    const Spacer(),
      isItemSelected? const CustomButtonOfBirthDayView(price: "EGP 500.0",):const Text(""),
